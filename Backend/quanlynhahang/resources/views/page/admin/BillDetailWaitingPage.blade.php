...
<body class="bg-img">
    ...
    <div class="container">
        <div class="row">
            <h3 class="text-white">Xử lý đơn hàng</h3>
            <div class="col-12">
                <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <form action="{{route('Kiemtradonhang',['bill_id'=>$item->BILL_ID])}}"
                                            method="post">
                                            @csrf
                                            <div class="form-group">
                                                <label>Ghi chú:</label>
                                                <textarea class="form-control" name="bills_note"
                                                    id="exampleFormControlTextarea1"
                                                    rows="3">{{$item->BILL_NOTE}}</textarea> </div>
                                    </div>
                                </div>
                                <!-- /.card-body -->
                            </div>
                                    ...
                                    <div class="col-12">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                $no=1;
                                                @endphp
                                                @foreach ($billdetailWaiting as $item )
                                                @php
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary float-right"><i class="fas fa-check mr-1"></i>Duyệt
                            đơn hàng</button>
                    </div>
                    </form>
                    <!-- /.card-body -->

...
<head>
    ...
    <link rel="stylesheet" href="{{asset('order/fontawesome/css/all.min.css')}}">
...
<body class="bg-primary" >
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-while shadow-sm">
            ...
            <div id="my-nav" class="collapse navbar-collapse">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button"
                            aria-haspopup="true" aria-expanded="false">Phòng/sảnh</a>
                ...
                <div class="modal fade" id="addroomandhall" tabindex="-1" role="dialog"
                    aria-labelledby="addroomandhallModalLabel" aria-hidden="true">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="inputroomhall" class="form-control"
                                                placeholder="Sảnh A">
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="row">
                                    ...
                                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                        <li class="nav-item dropdown mr-2">
                                            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#"
                                                role="button" aria-haspopup="true" aria-expanded="false">Phòng/Sảnh</a>
                                            <div class="dropdown-menu">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" id="pills-home-tab" data-toggle="pill"
                                                href="#table" role="tab" aria-controls="pills-home"
                                                aria-selected="true">Bàn</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#foods"
                                                role="tab" aria-controls="pills-profile" aria-selected="false">Thực
                                                đơn</a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="card-body card-body-height-left" style="overflow-y: scroll">
                                <div class="container">
                                    <div class="row" ng-repeat='table in tables'>
                                        <div class="filtr-item col-sm-2 bg-light border rounded mt-3 mr-3 pt-1"
                                            data-category="2" data-sort="white sample">
                                            <button type="button" class="close m-0" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                            <img src="https://via.placeholder.com/300/ffff?text=2"
                                                class="img-fluid mb-2" alt="white sample" />

                                        </div>
                                        <div class="filtr-item col-sm-2 bg-light border rounded mt-3 mr-3 pt-1"
                                            data-category="2" data-sort="white sample">
                                            <img src="{{asset('image/plus.png')}}" class="img-fluid mb-2"
                                                alt="white sample" />
                                        </div>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-3 mt-2">
                                            <div class="card">
                                                <div class="card-body">
                                                    <img src="https://via.placeholder.com/300/f70404?text=1"
                                                        class="img-fluid mb-2" alt="white sample" />
            ...
            <div class="col-6 ">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body  card-body-height-right" style="overflow-y: scroll ">
                        ...
                        <div class=" post border mt-1 p-2 rounded shadow-sm">
                            <div class="user-block">
                                <img class="img-bordered rounded-circle img-bordered-sm img-thumbnail img-fluid"
                                    src="{{asset('image/smart-cart.png')}}" alt="user image">
                                <span class="ml-2">
                                    <a href="#">Tên món ăn: </a>
                                </span>
                            ...
                            <p class="m-0">
                                <a href="#" class="link-black text-sm"><i
                                        class="fas fa-info-circle mr-1 text-primary ml-2"></i></i> Số lượng: 1</a>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade" id="mergebill" tabindex="-1" role="dialog"
                                        aria-labelledby="mergebillModalLabel" aria-hidden="true">
                                                            ...
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-6">
                                                                        ...
                                                                        <button type="submit"
                                                                            class="btn btn-primary float-right">Ghép
                                                                            đơn</button>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="container">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        <div class="card">
                                                                            <div class="card-body card-merge-bill"
                                                                                style="overflow-y: scroll">
                                                                                <div
                                                                                    class=" post border mt-1 p-2 rounded shadow-sm">
                                                                                    <div class="user-block">
                                                                                        <img class="img-bordered rounded-circle img-bordered-sm img-thumbnail img-fluid"
                                                                                            src="{{asset('image/smart-cart.png')}}"
                                                                                            alt="user image">
                                                                                        <span class="ml-2">
                                                                                            <a href="#">Tên món ăn: </a>
                                                                                        </span>
                                                                                        <span class="ml-2">abc</span>
                                                                                        <div
                                                                                            class="custom-control custom-checkbox close mb-2">
                                                                                            <input type="checkbox"
                                                                                    ...
                                                                                    <p class="m-0">
                                                                                        <a href="#"
                                                                                            class="link-black text-sm"><i
                                                                                                class="fas fa-info-circle mr-1 text-primary ml-2"></i></i>
                                                                                            Số lượng: 1</a>
                                                                                        <span class="float-right">
                                                                                            <a href="#"
                                                                                                class="link-black text-ml">
                                                                                                <i
                                                                                                    class="fas fa-toggle-on mr-1 text-success"></i>
                                                                                                Đơn giá: 20.000
                                                                                            </a>
                                                                                        </span>
                                                                                    </p>
                                                                            ...
                                                                            <div class="card-footer bg-while">
                                                                                <button type="submit"
                                                                                    class="btn btn-primary float-md-right">Tạo
                                                                                    hóa đơn</button>
                                                                            </div>
                                                                        </div>
                                ...
                                <div class="col-6">
                                    <button type="button" class="btn btn-primary float-lg-right" data-toggle="modal"
                    ...
                    <!-- Modal -->
                    <div class=" modal fade modal-right" id="staticBackdrop" data-backdrop="static" tabindex="-1"
                                                        ...
                                                        <div class="col-4">
                                                            <div class="custom-control custom-checkbox">
                                                                ...
                                                                <label class="custom-control-label text-success"
                                                                    for="customCheck1">Trả một phần</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
    ...
    <script src="{{asset('order/js/jquery-3.5.1.min.js')}}"></script>
    <script src="{{asset('order/js/js-sidebar.js')}}"></script>
    <script src="{{asset('angularjs/lib/angular.min.js')}}"></script>
    <script src="{{asset('angularjs/app/app.js')}}"></script>
</body>
